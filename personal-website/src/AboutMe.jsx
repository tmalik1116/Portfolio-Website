  ...
  return (
    <div id="home" className="flex flex-col md:flex-row items-center gap-3 py-6 justify-around px-4 md:px-6">
      <div className="flex flex-col w-full md:w-1/2">
        ...
        <h2 className="mb-4">I am a fourth year student in the Bachelor of Computing, Computer Science Co-op program at the University of Guelph.</h2>
        <h2 className="mb-4">I have had an interest in technology for years, with professional experience in full-stack development, machine learning, data science, and project management.</h2>
